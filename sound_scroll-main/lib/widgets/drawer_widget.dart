      ...
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            title: const Text('+91 7255848723'),
            onTap: () async {
              if (!await launchUrl(Uri.parse("tel:+91 7255848723"))) {
          ...
          ListTile(
            ...
            title: const Text('miss.anshikashashwat2000@gmail.com'),
            onTap: () async {
              if (!await launchUrl(
                  Uri.parse("mailto:miss.anshikashashwat2000@gmail.com"))) {
                throw Exception('Could not launch"');
              }
            },
          ),
